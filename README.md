...
2. The code used to run the experiments are located in the "code" directory
    ...
    b. synthetic_data.mlx - A Matlab script that estimates the contemporaneous causal relationships and changing modules for *Synthetic Data* using the lagged relationships estimated in 2(a).
    
    c. ot_conservative.mlx - A Matlab script that estimates the contemporaneous causal relationships and changing modules for *Conservative Oxygen Therapy* using the lagged relationships estimated in 2(a).
    
    d. ot_liberal.mlx - A Matlab script that estimates the contemporaneous causal relationships and changing modules for *Liberal Oxygen Therapy* using the lagged relationships estimated in 2(a).
...
# Step 3: 
Import the Matlab scripts to the Matlab data directory and run. There are three code files for three experiments that we have conducted in our paper. Separate code files for synthetic, and real-world data are provided in the “code” folder.
# Step 4: 
